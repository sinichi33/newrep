...
require_once(dirname(__FILE__) . '/../veritrans_old.php');
...
//var_dump($body);exit();
  ...
  {
    return $this->veritrans->payment_type;
  }
...
//    }
//    if(count($this->veritrans->installment_terms) > 0) {
//        $data[$payment_type_str]['payment_options']['installment']['required'] = TRUE;
//        $data[$payment_type_str]['payment_options']['installment']['installment_terms'] = $this->veritrans->installment_terms;
//    }
//    if(count($this->veritrans->promo_bins) > 0)
//      $data[$payment_type_str]['credit_card_bins'] = $this->veritrans->promo_bins;
