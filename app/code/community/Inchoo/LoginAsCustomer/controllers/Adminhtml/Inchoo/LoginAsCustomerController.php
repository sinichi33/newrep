...
class Inchoo_LoginAsCustomer_Adminhtml_Inchoo_LoginAsCustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    /**
     * for users who have selective permissions (not admin permissions) need to implement this.
     * @return bool
     */
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('system/config/inchoo_loginAsCustomer');
    }
