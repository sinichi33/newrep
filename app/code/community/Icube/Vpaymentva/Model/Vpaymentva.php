<?php
class Icube_Vpaymentva_Model_Vpaymentva extends Mage_Payment_Model_Method_Abstract
{
    const STATE_PENDING   = 'pending';
    const BANK_PERMATA   = 'permata';
    const CODE_MANDIRI_BILLPAYMENT   = 'echannel';

    protected $_code = 'vpaymentva';
    protected $_formBlockType = 'vpaymentva/form_vpaymentva';
    protected $_infoBlockType = 'vpaymentva/info_vpaymentva';
    ...
    public function assignData($data)
    {
        ...
        $info->setVabank($data->getVabank())
            ->setVanumber($data->getVanumber())
            ->setBillercode($data->getBillercode())
            ->setBillkey($data->getBillkey());
