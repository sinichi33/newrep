<?php
class Icube_Vpaymentva_Adminhtml_PromoController extends Mage_Adminhtml_Controller_Action
{
    ...
    {  
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('vpaymentva/adminhtml_promo_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('vpaymentva/promo_promo');
    }
}