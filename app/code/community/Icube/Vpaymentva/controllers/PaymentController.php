...
class Icube_Vpaymentva_PaymentController extends Mage_Core_Controller_Front_Action {
  ...
  public function processAction() {
    ...
    if ($session->getTokenBrowser() == null) {
      $this->_redirect('vpaymentva/payment/unauthorized');
    } else {
      $this->loadLayout();
  ...
  protected function _clearVeritransSession() {
    ...
    protected function getQuoteGrandTotalAction() {
        try{
            ...
            $quote->getPayment()->importData(array('method' => 'vpaymentva'));
