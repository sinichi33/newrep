<?php
class Icube_Vpaymentva_Block_Form_Vpaymentva extends Mage_Payment_Block_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('vpaymentva/form/vpaymentva.phtml');
    }
    ...
    public function getStoreConfig(){
        return Mage::getStoreConfig('payment/vpaymentva/client');
    }
