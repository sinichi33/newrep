<?php
class Icube_Vpaymentva_Block_Redirect extends Mage_Core_Block_Template {
  ...
  protected function _construct() {
    $this->setTemplate('vpaymentva/redirect.phtml');
  }
  ...
  public function getVeritransGatewayUrl() {
    return Mage::getStoreConfig('payment/vpaymentva/vurl');
  }
}