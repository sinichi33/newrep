<?php
class Icube_Vpaymentins_Adminhtml_PromoController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            try {
                $model = Mage::getModel('vpaymentins/program');
                $model->setId($id);
                $model->delete();
    ...
    {  
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('vpaymentins/adminhtml_promo_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
    ...
    public function saveAction()
    {
        if ($postData = $this->getRequest()->getPost()) {
            $model = Mage::getSingleton('vpaymentins/program');
    ...
    {
        $data = Mage::getModel('vpaymentins/program')->load($this->getRequest()->getParam('id'));
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('vpaymentins/promo_promo');
    }
}