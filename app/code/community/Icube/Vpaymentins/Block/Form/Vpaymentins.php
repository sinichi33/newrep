<?php
class Icube_Vpaymentins_Block_Form_Vpaymentins extends Mage_Payment_Block_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('vpaymentins/form/vpaymentins.phtml');
    }
    ...
    public function getStoreConfig(){
        return Mage::getStoreConfig('payment/vpaymentins/client');
    }
    ...
    */
    ...
    {
        $this->promo_collection = Mage::getModel('vpaymentins/program')->getCollection()
...
//                ))
    ...
    {
        $promoCode = Mage::helper('checkout')->getQuote()->getPayment()->getPromoCode();
        ...
        foreach($coll as $prom) {
            $html = $html . '<div class="input-box">
                <div class="v-fix">
                    <input type="radio" name="payment[promo]" id="promo_'.$prom->getPromoCode().'" value="'.$prom->getPromoCode().'" onclick="" class="radio" '.($prom->getPromoCode()==$promoCode?"checked":"").'/>
                </div>
