<?php
class Icube_Vpaymentins_Block_Redirect extends Mage_Core_Block_Template {
  ...
  protected function _construct() {
    $this->setTemplate('vpaymentins/redirect.phtml');
  }
  ...
  public function getVeritransGatewayUrl() {
    return Mage::getStoreConfig('payment/vpaymentins/vurl');
  }
}