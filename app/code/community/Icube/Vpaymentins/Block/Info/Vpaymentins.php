...
class Icube_Vpaymentins_Block_Info_Vpaymentins extends Mage_Payment_Block_Info_Cc
{
    /**
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        if (!$this->getIsSecureMode()) {
            $transport->addData(array(
                ...
                Mage::helper('payment')->__('Credit Card Number') => 'xxxxxxxxxxxx'.$this->getInfo()->getCcLast4(),
                Mage::helper('vpaymentins')->__('Bank') => $this->getInfo()->getInsbank(),
                Mage::helper('vpaymentins')->__('Tenor') => $this->getInfo()->getInstenor(),
            ));
        }
        return $transport;
    }
