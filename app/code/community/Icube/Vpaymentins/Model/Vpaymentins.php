<?php
class Icube_Vpaymentins_Model_Vpaymentins extends Mage_Payment_Model_Method_Abstract
{
    const STATE_PENDING   = 'pending';

    protected $_code = 'vpaymentins';
    protected $_formBlockType = 'vpaymentins/form_vpaymentins';
    protected $_infoBlockType = 'vpaymentins/info_vpaymentins';
    ...
    public function assignData($data)
    {
        ...
        $info->setCcType($data->getCcType())
            ...
            ->setInsbank($data->getInsbank())
            ->setInstenor($data->getInstenor());
