 ...
 */
class MDN_AutoCancelOrder_Adminhtml_AutoCancelOrder_AdminController extends Mage_Adminhtml_Controller_Action {
    ...
    public function viewOrderAction() {
        ...
        try {
            ...
            Mage::getSingleton('adminhtml/session')->addError($ex->getMessage());
            $this->_redirect('Adminhtml/AutoCancelOrder_admin/showLogs');
        }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/system/config/autocancelorder');
    }
}