...
class MDN_AutoCancelOrder_Block_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   /**
    ...
    public function getRowUrl($row) {
        return $this->getUrl('adminhtml/AutoCancelOrder_Admin/viewOrder', array('log_id' => $row->getId()));
    }
    ...
    public function getBackUrl(){
        return $this->getUrl('adminhtml/AutoCancelOrder_Admin/backToConfig');
    }
    ...
    public function getDeleteUrl(){
         return $this->getUrl('adminhtml/AutoCancelOrder_Admin/clearLogs');
    }
