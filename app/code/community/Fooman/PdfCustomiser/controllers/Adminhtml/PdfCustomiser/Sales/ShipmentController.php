    ...
    public function pdfshipmentsAction()
    {
        ...
        if (sizeof($orderIds)) {
            if (!Fooman_PdfCustomiser_Model_Abstract::COMPAT_MODE) {
                Mage::getModel('pdfcustomiser/shipment')->renderPdf(null, $orderIds, null, false, $this->getRequest()->getParam('force_store_id'));
            ...
            $shipments = Mage::getResourceModel('sales/order_shipment_collection')
                ...
                ->load();
            Mage::getModel('pdfcustomiser/shipment')->renderPdf($shipments, null, null, false, $this->getRequest()->getParam('force_store_id'));
        } else {
