    ...
    public function renderPdf(
            ...
            if ($creditmemos->getSize() > 0) {
                foreach ($creditmemos as $creditmemo) {
                    ...
                    if ($creditmemoHelper->getPrintBarcode()) {
                        $pdf->printHeader($creditmemoHelper, $creditmemoHelper->getPdfTitle(), $order->getIncrementId());
                    } else {
        ...
        if (!$suppressOutput) {
            if ($pdf->getPdfAnyOutput()) {
                ...
                $pdf->lastPage();
                $pdf->Output(
                    $creditmemoHelper->getPdfFileName($printedIncrements, null, $outputFileName),
