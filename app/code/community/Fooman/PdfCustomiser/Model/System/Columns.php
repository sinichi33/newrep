...
class Fooman_PdfCustomiser_Model_System_Columns
{
    ...
    public function toOptionArray()
    {
        return array(
            ...
            // ICUBE's custom
            array('value' => 'discount', 'label' => Mage::helper('sales')->__('Discount Amount')), 
            array('value' => 'price_after_disc', 'label' => Mage::helper('sales')->__('Price After Discount')), 
            array('value' => 'handling_fee_item', 'label' => Mage::helper('sales')->__('Handling Fee')), 
            array('value' => 'pos_price', 'label' => Mage::helper('sales')->__('POS Price')), 
