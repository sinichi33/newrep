...
/*
            self::TYPE_EACH_M_AFT_N_PERC    => $this->__('Percent Discount: each 1st, 3rd, 5th with 15% 0ff'),
            self::TYPE_EACH_M_AFT_N_DISC    => $this->__('Fixed Discount: each 3d, 7th, 11th with $15 0ff'),
            self::TYPE_EACH_M_AFT_N_FIX     => $this->__('Fixed Price: each 5th, 7th, 9th for $89.99'),
*/
        ...
        if (!$asOptions){
            ...
            $groups = array(
                ...
                //'Each M-th after N-th' => array(self::TYPE_EACH_M_AFT_N_PERC, self::TYPE_EACH_M_AFT_N_DISC, self::TYPE_EACH_M_AFT_N_FIX),
