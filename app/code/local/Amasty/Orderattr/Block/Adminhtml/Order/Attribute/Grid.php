    ...
    protected function _prepareColumns()
    {
        ...
        */
        ...
        $this->addColumn('checkout_step', array(
            ...
            'type' => 'options',
            'options' => array(
                '2' => Mage::helper('amorderattr')->__('1. Billing Information'),
                '3' => Mage::helper('amorderattr')->__('2. Shipping Information'),
                '4' => Mage::helper('amorderattr')->__('3. Shipping Method'),
                '5' => Mage::helper('amorderattr')->__('4. Payment Information'),
                '6' => Mage::helper('amorderattr')->__('5. Order Review'),
            ),
            'align' => 'center',
        ));
