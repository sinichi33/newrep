...
//            'class' => 'no-display',
        ...
        $inputTypes = array(
            ...
            array(
              ...
              array(
                'value' => 'checkboxes',
                'label' => Mage::helper('catalog')->__('Checkbox Group')
            ),
            array(
                'value' => 'radios',
...
//      do not need additional types  Mage::dispatchEvent('adminhtml_product_attribute_types', array('response'=>$response));
        ...
        $requiredValues[] = array(
            'value' => 2,
            'label' => Mage::helper('amorderattr')->__('On the Frontend Only')
        );
        ...
        $fieldset->addField('frontend_class', 'select', array(
            ...
            'values'=>  array(
                ...
                // Icube Update - add validations
                array(
                    'value' => 'validate-length maximum-length-5 minimum-length-1',
                    'label' => Mage::helper('catalog')->__('Length less or equal than 5 characters')
                ),
                array(
                    'value' => 'validate-length maximum-length-15 minimum-length-1 validate-digits',
                    'label' => Mage::helper('catalog')->__('Length less or equal than 15 characters and number only')
                ),
                 array(
                    'value' => 'validate-length maximum-length-25 minimum-length-1',
                    'label' => Mage::helper('catalog')->__('Length less or equal than 25 characters')
                ),
                array(
                    'value' => 'validate-length maximum-length-35 minimum-length-1',
                    'label' => Mage::helper('catalog')->__('Length less or equal than 35 characters')
                ),
            )
        ));
/*
        ...
        $fieldset->addField('checkout_step', 'select', array(
            ...
            'values'=>  array(
                array(
                    'value' => '2',
                    'label' => Mage::helper('amorderattr')->__('1. Billing Information')
                ),
                array(
                    'value' => '3',
                    'label' => Mage::helper('amorderattr')->__('2. Shipping Information')
                ),
                array(
                    'value' => '4',
                    'label' => Mage::helper('amorderattr')->__('3. Shipping Method')
                ),
                array(
                    'value' => '5',
                    'label' => Mage::helper('amorderattr')->__('4. Payment Information')
                ),
                array(
                    'value' => '6',
                    'label' => Mage::helper('amorderattr')->__('5. Order Review')
                ),
            )
        ));
        ...
        $fieldset->addField('show_on_grid', 'select', array(
            'name' => 'show_on_grid',
            'label' => Mage::helper('amorderattr')->__('Show on Admin Grids'),
        ...
        $fieldset->addField('include_html_print_order', 'select', array(
            ...
            'label'  => Mage::helper('amorderattr')->__('Include Into HTML Print-out'),
            'title'  => Mage::helper('amorderattr')->__('Include Into HTML Print-out'),
            'note'   => Mage::helper('amorderattr')->__('Order confirmation HTML print-out.'),
            'values' => $yesno,
        ));
