...
class Amasty_Orderattr_Block_Adminhtml_Order_Attribute_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        parent::__construct();
        $this->setTemplate('amasty/amorderattr/attribute/options.phtml');
    }
    ...
    public function getOptionValues()
    {
        ...
        if ($attributeType == 'radios' || $attributeType == 'select' || $attributeType == 'multiselect' || $attributeType == 'checkboxes' || $attributeType == 'boolean') {
