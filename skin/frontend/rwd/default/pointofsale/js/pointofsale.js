...
function displaySearch(error) {
    ...
    if (error) {
        ...
        msg = Builder.node("span", [W_GP.strings.setANewLocation, Builder.node("br")]);
...
function displayMyAddress(myAddress) {
    myPlace = Builder.node("div", [
        Builder.node("span", W_GP.strings.yourLocation + " : "),
        Builder.node("span", Builder.node("b", myAddress)),
        Builder.node("span", {"style": "float:right"}, [
